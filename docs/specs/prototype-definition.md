...
- **Beat detector:** benchmark librosa or Essentia against hand-marked beats; protect sections from mechanical every-beat cuts. **`madmom` is excluded** despite its accuracy — GPL licence and patchy maintenance make it unsafe for a potentially distributed product (ADR-003). An earlier draft of this document proposed benchmarking it; that was an error.
