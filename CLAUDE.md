...
**Stage A — Direction: closed 2026-07-23.** `PROJECT.md`, `ROADMAP.md`, and the governing ADRs are all accepted following the **2026-07-23 pivot** to a human-directed, approval-gated editor. **Stage B (Specification) is next. Documents only — no code, no media, no remote repository exists.** Read [handoff.md](handoff.md) before assuming anything exists.
